package com.kiroule.campsitebooking.contract.v1;

import com.kiroule.campsitebooking.contract.v1.model.BookingDto;
...
public interface BookingApiContractV1 {
  ...
  ResponseEntity<EntityModel<BookingDto>> updateBooking(
