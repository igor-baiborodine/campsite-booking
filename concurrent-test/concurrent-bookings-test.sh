...
payload1=$(< test/booking-payload.json sed -e "s/UUID/$(uuidgen)/g" \
...
payload2=$(< test/booking-payload.json sed -e "s/UUID/$(uuidgen)/g" \
...
payload3=$(< test/booking-payload.json sed -e "s/UUID/$(uuidgen)/g" \
